...
const prompt = "Does this image contain a scene of two people kissing or displaying romantic affection? Respond only with 'yes' or 'no' without any punctuation.";
