...
const getPoem=async(req,res)=>{
    ...
    try{
       ...
       // console.log(quotes);
        ...
        .json(new ApiResponse(200,{data:poems},"Get All Quote Successfully"))
    }
    catch(e){
        throw new ApiError(401,"Something went wrong in Getting Poem",e)
    }
}
const UserPoems=async(req,res)=>{
    ...
    console.log(userId);
     try {
        ...
        if(!poems){
            throw new ApiError(401,"Sorry Error in fetching poems")
        }
...
const deletePoem = async (req, res, next) => {
  try {
    ...
    const imageUrl = poem.BgImageUrl;
    ...
    res.status(200).json(new ApiResponse(200, {}, "Poem deleted successfully"));
  } catch (error) {
...
export {postPoem,getPoem,UserPoems,deletePoem}